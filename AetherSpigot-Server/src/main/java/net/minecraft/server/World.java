...
import xyz.aether.spigot.config.AetherWorldConfig;
// PaperSpigot end
...
public abstract class World implements IBlockAccess {
    ...
    */
    ...
    public final AetherWorldConfig aetherWorldConfig; // AetherSpigot
    ...
    protected World(IDataManager idatamanager, WorldData worlddata, WorldProvider worldprovider, MethodProfiler methodprofiler, boolean flag, ChunkGenerator gen, org.bukkit.World.Environment env) {
        ...
        this.aetherWorldConfig = new AetherWorldConfig(this, worlddata.getName()); // AetherSpigot
        this.generator = gen;
    ...
    public MovingObjectPosition rayTraceStripped(Vec3D vec3d, Vec3D vec3d1) {
        ...
        while (steps-- >= 0) {
            ...
            blockposition.c(currX, currY, currZ);
    ...
    // AetherSpigot start - CraftBukkit start
    public boolean addEntity(EntityPlayer entity) {
        if (entity == null) {
            return false;
        }
        this.players.add(entity);
        this.everyoneSleeping();
        this.getChunkAt(MathHelper.floor(entity.locX / 16.0), MathHelper.floor(entity.locZ / 16.0)).a(entity);
        this.entityList.add(entity);
        this.a(entity);
        return true;
    }

    public boolean addEntity(EntityFallingBlock entity) {
        if (entity == null) {
            return false;
        }
    ...
    public boolean addEntity(EntityTNTPrimed entity) {
        if (entity == null) {
            return false;
        }
        int i = MathHelper.floor(entity.locX / 16.0);
    ...
    public boolean addEntity(Entity entity, CreatureSpawnEvent.SpawnReason spawnReason) {
        ...
        if (entity instanceof EntityLiving && !(entity instanceof EntityPlayer)) {
            ...
            boolean bl = isMonster = entity instanceof EntityMonster || entity instanceof EntityGhast || entity instanceof EntitySlime;
            ...
            if (radius > 0.0) {
                ...
                for (Entity e : entities) {
                    if (!(e instanceof EntityExperienceOrb)) continue;
                    EntityExperienceOrb loopItem = (EntityExperienceOrb)e;
                    if (loopItem.dead) continue;
        ...
        (chunk == null ? this.getChunkAt(i, j) : chunk).a(entity);
        this.entityList.add(entity);
        this.a(entity);
        return true;
    }
            ...
            for (float f = 0.0F; f <= 1.0F; f = (float) ((double) f + d0)) {
                for (float f1 = 0.0F; f1 <= 1.0F; f1 = (float) ((double) f1 + d1)) {
                    for (float f2 = 0.0F; f2 <= 1.0F; f2 = (float) ((double) f2 + d2)) {
                        ...
                        if (this.rayTraceStripped(new Vec3D(d5 + d3, d6, d7 + d4), vec3d) == null) { // AetherSpigot
                            ++i;
                        }
    ...
    public void B(BlockPosition blockposition, float yaw, float pitch) {
        this.worldData.setSpawn(blockposition, yaw, pitch);
    }
