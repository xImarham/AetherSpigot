...
public abstract class EntityProjectile extends Entity implements IProjectile {
    ...
    public EntityProjectile(World world, EntityLiving entityliving) {
        ...
        double eyeHeight = entityliving.getHeadHeight();
        if (entityliving instanceof EntityPlayer) eyeHeight = 1.62D;
        this.setPositionRotation(entityliving.locX, entityliving.locY + eyeHeight, entityliving.locZ, entityliving.yaw, entityliving.pitch);
        // AetherSpigot end
        ...
        this.motY = (double) (-MathHelper.sin((float) ((this.pitch + this.l()) / 180.0F * 3.1415927F)) * f);
        this.shoot(this.motX, this.motY, this.motZ, (float) this.j(), 1.0F);
    }
    ...
    public void t_() {
        ...
        if (!this.world.isClientSide) {
            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                if (entity1.ad() && (entity1 != entityliving || this.ar >= world.aetherWorldConfig.potionTime)) {
                    float f = 0.3F;
