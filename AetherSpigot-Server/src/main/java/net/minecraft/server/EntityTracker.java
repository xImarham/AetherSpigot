...
public class EntityTracker {
    ...
    public Int2ObjectOpenHashMap<EntityTrackerEntry> trackedEntities = new Int2ObjectOpenHashMap<>(); // AetherSpigot
    private int e;
    ...
    public void track(Entity entity) {
        if (entity instanceof EntityPlayer) {
            this.addEntity(entity, 512, this.world.aetherWorldConfig.trackPlayersEveryTick ? 1 : 2);
            ...
            this.addEntity(entity, 64, Integer.MAX_VALUE, false);
